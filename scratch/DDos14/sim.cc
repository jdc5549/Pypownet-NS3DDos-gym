...
NS_LOG_COMPONENT_DEFINE("DDos_grid14");
...
int main(int argc, char *argv[])
{
    ...
    NetDeviceContainer d01, d04, d12, d13, d14, d23, d34, d36, d38, d45, d510, d511, d512, d67, d68, d89, d813, d910, d1112, d1213, botDeviceContainer[NUMBER_OF_BOTS];
    ...
    {
        botDeviceContainer[i] = pp1.Install(botNodes.Get(i), nodes.Get(6));
    }
    ...
    AnimationInterface anim("DDos_grid14.xml");
    ...
    {
        ns3::AnimationInterface::SetConstantPosition(botNodes.Get(l), x_pos+l*10, -220);
    }
